        ...
        <div className="gallery-wrapper">
            ...
            <section className="gallery" id="gallery">
                <div className="gallery-row gallery-row--1-3">
                    ...
                    <div className="gallery-row__item" style={{backgroundImage: 'url(/photos/roof_3.jpg)' }}></div>
                ...
                <div className="gallery-row gallery-row--1-2">
                    ...
                    <div className="gallery-row__item" style={{backgroundImage: 'url(/photos/roof_4.jpg)' }}></div>
                </div>
            </section>
        </div>
    )
